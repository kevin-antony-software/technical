...
<html lang="en">
    ...
    <body>
        ...
        This is to confirm recipt payment of Rs {{ $payment->totalAmount }} to K & K International Lanka Pvt Ltd
        from Customer {{ $payment->customer_name }} with method {{ $payment->method }}
